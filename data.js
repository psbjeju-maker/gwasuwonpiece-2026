...
window.GAME_DATA = {
  ...
  introQuest: {
    ...
    line: "어이, 거기 자네! 오늘 이 과수원에 발을 들였다는 건... 황금 귤 이야기를 들었다는 뜻이겠지? 🍊\n\n이 몸은 귤선장. 벌써 몇 년째 이 귤밭을 뒤지고 있다네. 자네, 이번 기회에 해적이 돼보지 않겠나?",
    /* choices의 path가 missionPaths(아래)의 키와 짝지어져, 등록 직후 진행상황 화면의 미션 순서를 바꾼다.
       미션 종류·개수는 그대로다 — 안내받는 순서만 다르다. */
    choices: [
      { label: "좋다, 몸으로 부딪혀 보겠다!", path: "action",
        next: "하하, 배짱 한번 좋군! 지금 이 순간부터 자네는 어엿한 해적일세. 양궁이든 사격이든 먼저 몸부터 풀어보게나. 행운을 비네, 해적 동료여.",
        avatar: "captain/exp_fighting.jpg" },
      { label: "좋다, 차근차근 둘러보겠소.", path: "social",
        next: "그것도 자네다운 방식이지. 지금 이 순간부터 자네는 어엿한 해적일세. 장터부터 슬슬 돌아보게나, 재밌는 게 많을 걸세.",
